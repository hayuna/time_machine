...
<button class="btn btn-primary logout">Wyloguj się</button>
...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="row">
            ...
            <div class="col-md-2"><input disabled="disabled" id="monthly_work_time" style="width:200px;margin-bottom:20px;"></div>
        </div>
...
<style>.row{margin-left:15px;margin-right:15px;}.datepicker.datepicker-dropdown.dropdown-menu{position:fixed;}</style>
